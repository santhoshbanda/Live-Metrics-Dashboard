...
import MetricAlertIcon from "../../components/metric-alert-icon/MetricAlertIcon.tsx";
import {getCPUMetricColors, getErrorMetricColors, randomNameGenerator} from "../../utils/common-functions.ts";
import ShuffleIcon from '@mui/icons-material/Shuffle';
import BasicSpeedDial from "../../components/basic-speed-dial/BasicSpeedDial.tsx";
import ApiService from "../../services/api.service.ts";
import { toast } from "react-toastify";
import AnalyticsModal from "../../components/analytics-modal/AnalyticsModal.tsx";
            ...
            <div className={'dashboard-cards-holder'}>
                {
                    services.map((service) => {
                        ...
                        }} className={'card-item cursor-pointer'} key={service.id}>
